...
public partial class thierry : Among_us_vert
{
    ...
    override protected void On_animation_finish(string anim_name)
    {
        ...
        if (anim_name == "mort")
        {
            string insertQuery = "INSERT INTO Collection(numeroCollection) VALUES(@numeroCollection)";
            SQLiteCommand insertCommand = new SQLiteCommand(insertQuery, db.getConnection);

            insertCommand.Parameters.AddWithValue("@numeroCollection", 11); //ajout de pouet a la collection
